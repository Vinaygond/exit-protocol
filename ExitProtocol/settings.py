...
MIDDLEWARE = [
    ...
    # WhiteNoise: Essential for serving static files in production
...
ROOT_URLCONF = 'ExitProtocol.urls'
...
# Celery Configuration (Synchronous fallback for simple deployments)
